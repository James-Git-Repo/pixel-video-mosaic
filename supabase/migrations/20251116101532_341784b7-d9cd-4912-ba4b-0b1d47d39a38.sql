-- Drop the old UUID version of create_slot_hold_atomic to resolve function overloading conflict
DROP FUNCTION IF EXISTS public.create_slot_hold_atomic(uuid, text, text, text[], integer);

-- Ensure only the TEXT version exists
-- This function accepts TEXT user_id to support anonymous users
