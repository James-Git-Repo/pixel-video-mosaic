...
-- Address multiple security linter warnings without breaking dependencies

-- 1. Update all functions to use SECURITY INVOKER instead of SECURITY DEFINER
-- and add proper search_path to fix security warnings

-- Update create_slot_hold_atomic function - use SECURITY INVOKER
...
-- Update is_admin function - use SECURITY INVOKER
...
-- Update free_occupied_slots function - use SECURITY INVOKER
